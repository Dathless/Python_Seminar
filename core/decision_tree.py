...
class Node:
    def __init__(self, feature=None, threshold=None, left=None, right=None, *, value=None):
        self.feature = feature      # Chỉ số của đặc trưng dùng để chia
...
class DecisionTreeManual:
    def __init__(self, min_samples_split=2, max_depth=10, n_features=None):
        ...
        self.n_features = n_features               # Số lượng đặc trưng sử dụng
        self.root = None
    ...
    def _entropy(self, y):
        """Tính toán chỉ số Entropy để đo lường độ vẩn đục"""
        hist = np.bincount(y)
        ps = hist / len(y)

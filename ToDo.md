...
## Task 5: Triển khai decision tree:

- Viết hàm tính Gini hoặc Entropy
- Xây dựng cấu trúc cây dựa trên information gain

## Task 6: Xây dựng trainer:

- Viết logic chia mini-batches
- Viết hàm capture_training_history để lưu loss/accuracy qua từng epoch
- Hiển thị nó ra giao diện model_training.html

## Task 7: Triển khai predict:

- Gọi 3 model, chạy đầu vào, dựa vào kết quả và accuracy kết quả chọn model đầu ra
- Hiển thị phù hợp ra predict.html
